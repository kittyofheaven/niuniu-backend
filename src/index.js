...
app.use(function (err, req, res, next) {
  ...
  res
    .status(500)
    .send("You have invalid JSON Format Type On Request Parameter");
});
...
app.get(`/${prefix}/sendNotification`, async (req, res) => {
  const message = {
    ...
    token:
      "cov6glZCR6eapv4KreRjN9:APA91bFhiH6pz-lY7rWPQZiwL2cfMVHMf8nXwcVfGtlWUfw5enbV6f7x1vgd68JKIdHHBeaaFz-CLK6UlnjoxPpPAZHRYUTOaeIXbOLj5TB75J0qghiB35QMZhT79PSHbho33SgPGuxg",
  };
