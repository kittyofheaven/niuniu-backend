...
const createDriverAccount = async (req, res) => {
    const { email, phone_number, first_name, last_name, password, hospital_id } = req.body;
    try{
        await driverAccountsServices.createDriverAccount(email, phone_number, first_name, last_name, password, hospital_id, res);
    } catch (error){
